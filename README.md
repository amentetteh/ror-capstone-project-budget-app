...
```sh
  cd my-folder
  git clone git@github.com:amentetteh/ror-capstone-project-budget-app.git
```
...
```sh
  cd ror-capstone-project-budget-app
  gem install
```
...
- Tweeter: [Amen Tetteh](https://www.tweeter.com/amentetteh/)
